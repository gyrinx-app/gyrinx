...
The implementation has twelve logical layers. The first eight shipped as stacked
PRs; the final four ship together in one completion PR. Review the layers in this
order. The stack starts at [PR #2579](https://github.com/gyrinx-app/gyrinx/pull/2579).
...
| 9 | [Existing-fighter initialisation](https://github.com/gyrinx-app/gyrinx/pull/2627) | One explicit maintenance operation using trustworthy starting XP and current XP. |
| 10 | [Card and picker display](https://github.com/gyrinx-app/gyrinx/pull/2627) | Tier effects and rating in pickers; tiers beneath equipment in screen, print, text and captured state. |
| 11 | [Fighter edit flows](https://github.com/gyrinx-app/gyrinx/pull/2627) | Action panels beneath the card, responsive step indicators, resumable forms and final review. |
| 12 | [Gallery and design record](https://github.com/gyrinx-app/gyrinx/pull/2627) | Production-component examples, an implementation guide and this reusable exploration directory. |
