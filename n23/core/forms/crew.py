...
class CrewFighterChoiceField(forms.ModelMultipleChoiceField):
    ...
    :func:`~n23.core.handlers.crew.with_crew_cost_data` — the label costs each
...
class CrewForm(forms.Form):
    ...
    def fighter_rows(self):
        ...
        :func:`~n23.core.handlers.crew.with_crew_cost_data` — no query per
...
class CrewSetupForm(forms.Form):
    ...
    :func:`n23.core.handlers.crew.default_crew_eligibility_state`); only the
