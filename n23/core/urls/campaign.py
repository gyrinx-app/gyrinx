...
patterns = [
    ...
    path(
        "battle/<battle_id>/crew/<uuid:crew_id>",
        crew_views.crew_detail,
        name="crew",
    ),
    path(
        "battle/<battle_id>/crew/<uuid:crew_id>/edit",
        crew_views.crew_edit,
        name="crew-edit",
    ),
    path(
        "battle/<battle_id>/crew/<uuid:crew_id>/setup",
        crew_views.crew_setup,
        name="crew-setup",
    ),
    path(
        "battle/<battle_id>/crew/<uuid:crew_id>/stash",
        crew_views.crew_stash,
        name="crew-stash",
    ),
    path(
    ...
    path(
        "battle/<battle_id>/crew/<uuid:crew_id>/ready",
        crew_views.crew_ready,
        name="crew-ready",
    ),
    path(
    ...
    path(
        "battle/<battle_id>/crew/<uuid:crew_id>/extra/<uuid:item_id>/edit",
        crew_views.crew_extra,
        name="crew-extra-edit",
    ),
    path(
        "battle/<battle_id>/crew/<uuid:crew_id>/extra/<uuid:item_id>/delete",
