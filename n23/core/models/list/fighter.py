...
if TYPE_CHECKING:
    ...
    from n23.core.models.list.campaign_state import ListFighterInjury
    from n23.core.models.list.equipment_set import ListFighterEquipmentSet
...
class ListFighterQuerySet(models.QuerySet):
        ...
        return (
            ...
            .prefetch_related(
                ...
                *rule_prefetches,
                ...
                # Equipment-injury links drive the treated/untreated marker and
                # SUPPRESS handling. all_content() keeps pack-owned links for a
                # subscribed list; see "Archived content pack behaviour" in
                # n23/AGENTS.md.
                Prefetch(
    ...
    def sq_advancement_cost_sum(self):
        ...
        """
        from n23.core.models.list.advancement import ListFighterAdvancement
    ...
    def sq_roll_result_cost_sum(self):
        ...
        This avoids JOIN duplication issues with direct Sum annotations.
        """
        from n23.core.models.list.roll_result import ListFighterRollResult
...
class ListFighter(AppBase):
    ...
    def _mods(self) -> pylist:
        ...
        """
        from n23.core.models.list.advancement import AdvancementStatMod
    ...
    def get_primary_skill_categories(self):
        ...
        """
        from n23.content.models import ContentModSkillTreeAccess
    ...
    def get_available_psyker_disciplines(self):
        ...
        """
        from n23.content.models import ContentModPsykerDisciplineAccess
    ...
    def category_restricted_gearline_display(self):
        ...
        for cat in restricted_categories:
            ...
            from n23.content.models import ContentFighterEquipmentCategoryLimit
    ...
    def clone(self, **kwargs):
        ...
        from n23.core.models.list.campaign_state import ListFighterCounter
