...
def complete_campaign_list_clone(
    ...
    from n23.core.handlers.campaign_operations import _distribute_budget_to_list
    from n23.core.handlers.list.operations import book_clone_actions
...
def propagate_default_child_fighter_assignment(default_assignment_id: str):
    ...
    # stays visible to gangs already subscribed (see n23/AGENTS.md "Content-pack
