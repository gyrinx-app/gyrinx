...
Fixtures here are scoped to ``n23/core/tests/``. Root-level fixtures live in
``conftest.py (repo root)`` and are available everywhere; this file adds fixtures
...
from n23.content.models import ContentEquipmentCategory
