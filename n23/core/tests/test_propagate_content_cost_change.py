...
from n23.core.models.list import List, ListFighterEquipmentAssignment
...
def test_signal_enqueues_on_commit_only(
    ...
    with patch("n23.core.tasks.propagate_content_cost_change") as mock_task:
...
def test_sweep_failure_enqueues_background_heal(
    ...
    with (
        patch(
            "n23.core.cost.pin_sweep.rewrite_pinned_amounts_for_list",
            side_effect=RuntimeError("boom"),
        ),
        patch("n23.core.tasks.refresh_list_facts") as mock_task,
    ):
