...
def test_crew_selection_form_includes_pack_crew(
    ...
    from n23.core.forms.vehicle import CrewSelectionForm
...
def test_subscribed_list_can_buy_pack_vehicle(
    ...
    from n23.core.forms.vehicle import VehicleSelectionForm
...
def test_default_assignment_post_accepts_pack_vehicle(
    ...
    with patch(
        "n23.core.models.list.signal_handlers.propagate_default_child_fighter_assignment"
    ) as mock_task:
