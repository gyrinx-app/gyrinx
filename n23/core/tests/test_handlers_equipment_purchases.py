...
These tests directly test the handler functions in n23.core.handlers.equipment,
...
def test_accessory_purchase_failure_preserves_existing_accessories(
    ...
    """
    from n23.content.models import ContentWeaponAccessory
...
def test_profile_purchase_failure_preserves_existing_profiles(
    ...
    """
    from n23.content.models import ContentWeaponProfile
...
def test_handle_equipment_sale_entire_assignment(
    ...
    assert result.list_action.stash_delta == -50  # Equipment cost removed from stash
