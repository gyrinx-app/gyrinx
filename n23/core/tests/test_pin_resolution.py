...
from n23.core.handlers.equipment.reassignment import handle_equipment_reassignment
...
def test_pinned_upgrade_amount_shows_on_display_path(weapon_assignment):
    ...
    from n23.core.models.list import VirtualListFighterEquipmentAssignment
