...
def test_packs_index_shows_own_packs_when_my_off(client, group_user, make_user):
    ...
    from n23.core.models.pack import CustomContentPackPermission
...
def test_add_fighter_statline_type_includes_vehicle(pack, fighter_statline_type):
    ...
    """
    from n23.core.forms.pack import ContentFighterPackForm
...
def test_add_weapon_with_traits(client, group_user, pack, weapon_category):
    ...
    from n23.content.models.weapon import ContentWeaponProfile, ContentWeaponTrait
...
def test_add_weapon_duplicate_name_integrity_error(
    ...
    with patch(
        "n23.core.forms.pack.ContentWeaponPackForm.clean_name",
...
def test_add_gear_duplicate_name_integrity_error(
    ...
    # Patch clean_name to bypass form-level validation so the DB constraint fires.
    with patch(
        "n23.core.forms.pack.ContentGearPackForm.clean_name",
        lambda self: self.cleaned_data["name"],
    ):
        response = client.post(
            f"/pack/{pack.id}/add/gear/",
...
def test_rich_text_description_widget_has_no_image_support():
    ...
    """
    from n23.core.forms.pack import rich_text_description_widget
