...
Run: pytest gyrinx/core/tests/test_cotton_call_site_gates.py
"""
...
TEMPLATE_ROOTS = [REPO_ROOT / "gyrinx"]
...
def html_files():
    for root in TEMPLATE_ROOTS:
        for path in sorted(root.rglob("*.html")):
            ...
            # gyrinx/core/templates/cotton_test/, then delete them again; under
...
STOCK_RENDER_SITES = {
    "gyrinx/core/templates/admin/core/notification/broadcast.html",
    "gyrinx/core/templates/mfa/recovery_codes/generate.html",
    "gyrinx/core/templates/mfa/totp/deactivate_form.html",
}
