"""Platform debug views: the test-plan browser and the design-system reference.

Both are about the tooling, not the game. The edition's debug views (balance
sheet, list actions, print lab) stay in n23.core.views.
"""
