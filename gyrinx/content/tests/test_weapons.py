...
def test_special_ammo_weapon():
    ...
    autogun_static_rounds_profile = ContentWeaponProfile.objects.create(
        equipment=autogun,
        name="static rounds",
        cost=10,
        cost_sign="+",
    ...
    autogun_warp_rounds_profile = ContentWeaponProfile.objects.create(
        equipment=autogun,
        name="warp rounds",
        cost=15,
        cost_sign="+",
...
def test_two_standard_stats():
    ...
    combat_shotgun = ContentEquipment.objects.create(
        name="Combat shotgun",
        category=EquipmentCategoryChoices.BASIC_WEAPONS,
        cost=70,
        rarity="R",
    ...
    combat_shotgun_salvo_profile = ContentWeaponProfile.objects.create(
    ...
    combat_shotgun_shredder_profile = ContentWeaponProfile.objects.create(
        equipment=combat_shotgun,
        name="shredder ammo",
        cost=0,
        cost_sign="+",
...
def test_combi_weapon():
    autopistol_combi_pistol_hand_flamer = ContentEquipment.objects.create(
    ...
    autopistol_combi_pistol_plasma_pistol = ContentEquipment.objects.create(
    ...
    autopistol_combi_pistol_hand_flamer_autopistol = (
    ...
    autopistol_combi_pistol_plasma_pistol_autopistol = (
        ContentWeaponProfile.objects.create(
    ...
    autopistol_combi_pistol_hand_flamer_profile = ContentWeaponProfile.objects.create(
        equipment=autopistol_combi_pistol_hand_flamer,
        name="Hand flamer",
        range_short="",
        range_long="T",
    ...
    autopistol_combi_pistol_plasma_pistol_profile = ContentWeaponProfile.objects.create(
        equipment=autopistol_combi_pistol_plasma_pistol,
        name="Plasma pistol",
        range_short='6"',
        range_long='12"',
...
def test_autogun_combi_weapon():
    autogun_combi_flamer = ContentEquipment.objects.create(
    ...
    autogun_combi_grenade_launcher = ContentEquipment.objects.create(
    ...
    autogun_combi_flamer_autogun = ContentWeaponProfile.objects.create(
    ...
    autogun_combi_grenadae_launcher_autogun = ContentWeaponProfile.objects.create(
    ...
    autogun_combi_flamer_flamer = ContentWeaponProfile.objects.create(
        equipment=autogun_combi_flamer,
        name="Flamer",
        range_short='6"',
        range_long="T",
    ...
    autogun_combi_grenade_launcher_frag = ContentWeaponProfile.objects.create(
        equipment=autogun_combi_grenade_launcher,
        name="Frag Grenades",
        range_short='6"',
        range_long='24"',
    ...
    autogun_combi_grenade_launcher_krak = ContentWeaponProfile.objects.create(
        equipment=autogun_combi_grenade_launcher,
        name="Krak Grenades",
        cost=25,
        cost_sign="+",
    ...
    autogun_combi_grenade_launcher_stun = ContentWeaponProfile.objects.create(
        equipment=autogun_combi_grenade_launcher,
        name="Stun Rounds",
        cost=20,
        cost_sign="+",
    ...
    autogun_combi_grenadae_launcher_autogun.save()
    ...
    assert (
        autogun_combi_grenadae_launcher_autogun.equipment
...
def test_two_modes():
    ...
    kroot_long_rifle = ContentEquipment.objects.create(
    ...
    kroot_long_rifle_ranged_profile = ContentWeaponProfile.objects.create(
    ...
    kroot_long_rifle_melee_profile = ContentWeaponProfile.objects.create(
        equipment=kroot_long_rifle,
        name="melee",
        range_short="E",
        range_long='2"',
...
def test_grenades():
    ...
    blasting_charge = ContentEquipment.objects.create(
    ...
    blasting_charge_profile = ContentWeaponProfile.objects.create(
