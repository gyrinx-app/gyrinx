...
class ContentEquipmentQuerySet(models.QuerySet):
    ...
    def with_expansion_cost_for_fighter(
        self, content_fighter: "ContentFighter", list_obj
    ) -> "ContentEquipmentQuerySet":
        """
        ...
        for expansion in ContentEquipmentListExpansion.objects.prefetch_related(
            ...
            if expansion.applies_to(list_obj, content_fighter):
...
class ContentEquipmentListExpansion(Content):
    ...
    @classmethod
    def get_applicable_expansions(cls, list_obj, fighter=None):
        """
    ...
    @classmethod
    def get_expansion_equipment(cls, list_obj, fighter=None):
        """
