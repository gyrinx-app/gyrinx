        ...
        [
            ...
            Component(
                ...
                notes=(
                    ...
                    "read three ways and no total can fall out of date. An empty "
            ...
            Component(
                ...
                notes=(
                    ...
                    "in a button is furniture. Where it is drawn it is drawn as a "
                    "link and not as a quiet button, because it is one — it goes "
                    "to the thing it names — and the two halves do different "
                    "things: a reader who cannot tell them apart presses the name "
                    "expecting the list and gets a page. Both are as narrow as "
                    "they can be, the name with no padding at all and the chevron "
                    "with only what a pressable square needs, so the pair reads as "
                    "one object beside a heading rather than as two controls near "
                    "each other. The panel is the "
                    ...
                    "second copy of the list — and it was not taken because a "
                    "<summary> is neither a button nor a link: it would have to be "
                    "given back the focus ring, the hover and everything the "
                    "dropdown gets right. The price of that choice "
