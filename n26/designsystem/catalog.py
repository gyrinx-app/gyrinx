        ...
        [
            ...
            Component(
                ...
                notes=(
                    ...
                    "single offset. The section strip draws as many tabs as the row "
                    "has room for and puts the rest behind a chevron, measured off "
                    "an invisible copy of itself rather than off a breakpoint: section "
                    "names come from content, so how many fit is a fact about these "
                    "names at this width. It fails towards showing everything and "
                    "wrapping, because the other failure — a strip that measures "
                    "zero and hides every section — is the one nobody can recover "
                    "from. Categories collapse, because "
