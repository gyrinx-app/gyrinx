...
`
    ...
    x(
        "refs",
        (t) => (
            t._x_refs_proxy || (t._x_refs_proxy = P(Gi(t))),
            t._x_refs_proxy
        ),
    );
    function Gi(t) {
    ...
    function On(t) {
        ...
        return (
            e || E(`Cannot find x-teleport element for selector: "${t}"`),
            e
        );
    }
    var Cn = () => {};
