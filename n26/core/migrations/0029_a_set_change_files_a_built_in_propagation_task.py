...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name="BuiltInPropagationTaskStateTransition",
            fields=[
                (
                    "id",
                    models.UUIDField(
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        to="n26.builtinpropagationtask",
                    ),
                ),
            ],
            options={
                "verbose_name": "built-in propagation task state transition",
                "verbose_name_plural": "built-in propagation task state transitions",
