...
the gang's Spend built-in Trade Points activity is open. So it is kept the way
...
purchase that recorded a Spend built-in Trade Points activity of this gang, on
...
class FoundingBudget:
    ...
    ``activity`` is the gang's open Spend built-in Trade Points activity — the row
