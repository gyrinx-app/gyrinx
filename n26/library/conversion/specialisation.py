...
def plan_specialisation():
    ...
    # slot shows every pick it holds, so the page would gain a repeated
    # answer and lose those lines. That is a change to what a reader is
    # told, and not one a conversion may make on its own — the spare
    ...
    if crowded:
        ...
        problems.append(
            ...
            f"a single slot cannot say the same way: {named}"
        )
